  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-foreground/[0.06] bg-background/70 px-4 backdrop-blur-2xl lg:px-6">
      ...
      <button
        ...
        className="group flex flex-1 items-center gap-2.5 rounded-xl border border-foreground/10 bg-foreground/[0.03] px-3.5 py-2 text-sm text-muted-foreground transition-all hover:border-primary/25 hover:bg-foreground/[0.06] sm:max-w-sm"
      >
